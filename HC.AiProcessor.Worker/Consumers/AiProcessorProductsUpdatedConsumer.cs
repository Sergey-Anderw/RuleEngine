...
internal sealed class AiProcessorProductsUpdatedConsumer(
    IServiceProvider serviceProvider,
    IAiProcessorQueue queue)
    : IConsumer<IProductsUpdatedCommand>
{
    ...
    public async Task Consume(ConsumeContext<IProductsUpdatedCommand> context)
    {
